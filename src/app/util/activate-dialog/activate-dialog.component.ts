...
import {activateHeadMessage,activateContentMessage} from '../constants';


@Component({
  selector: 'app-activate-dialog',
  templateUrl: './activate-dialog.component.html',
  styleUrls: ['./activate-dialog.component.less']
})
export class ActivateDialogComponent implements OnInit {
  activateHeadMsg = activateHeadMessage;
  activateContentMsg = activateContentMessage;
  key :string;
  showComment:boolean;
  showContent :string = "";
  constructor(public dialogRef: MatDialogRef<any>,
    ...
    activeformgroup: UntypedFormGroup =this.formbuilder.group({
  ...
  activateDetails(){
    this.dialogRef.close({data:true,comments:this.activeformgroup.value.comments});
  }
